...
import { Mail, Lock, Chrome, Zap, Target, Award } from 'lucide-react';
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-[#06162B] mb-2">Welcome back</h2>
            <p className="text-slate-600">Sign in to continue your interview prep journey</p>
          </div>
